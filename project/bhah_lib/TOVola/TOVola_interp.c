...
static void TOVola_TOV_interpolate_1D(REAL rr_iso, const commondata_struct *restrict commondata, const int interpolation_stencil_size,
                                      const int numpoints_arr, const REAL *restrict r_Schw_arr, const REAL *restrict rho_energy_arr,
...
/**
 * Provide high-order interpolation from TOVola grids onto an arbitrary point xCart[3] = {x,y,z} in the Spherical basis.
 */
