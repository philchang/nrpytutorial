...
const REAL_SIMD_ARRAY grid_hole_radius = ConstSIMD(NOSIMDgrid_hole_radius);               // nrpy.reference_metric::grid_hole_radius
...
const REAL_SIMD_ARRAY initial_central_density = ConstSIMD(NOSIMDinitial_central_density); // TOVola::initial_central_density
const REAL NOSIMDinitial_ode_step_size = commondata->initial_ode_step_size;               // TOVola::initial_ode_step_size
const REAL_SIMD_ARRAY initial_ode_step_size = ConstSIMD(NOSIMDinitial_ode_step_size);     // TOVola::initial_ode_step_size
...
const REAL_SIMD_ARRAY max_step_size = ConstSIMD(NOSIMDmax_step_size);                  // TOVola::max_step_size
const REAL NOSIMDmin_step_size = commondata->min_step_size;                            // TOVola::min_step_size
const REAL_SIMD_ARRAY min_step_size = ConstSIMD(NOSIMDmin_step_size);                  // TOVola::min_step_size
...
const REAL_SIMD_ARRAY ode_error_limit = ConstSIMD(NOSIMDode_error_limit); // TOVola::ode_error_limit
...
const REAL_SIMD_ARRAY PI = ConstSIMD(NOSIMDPI);                           // nrpy.reference_metric::PI
const REAL NOSIMDpoly_eos_Gamma = commondata->poly_eos_Gamma;             // TOVola::poly_eos_Gamma
const REAL_SIMD_ARRAY poly_eos_Gamma = ConstSIMD(NOSIMDpoly_eos_Gamma);   // TOVola::poly_eos_Gamma
const REAL NOSIMDpoly_eos_K = commondata->poly_eos_K;                     // TOVola::poly_eos_K
const REAL_SIMD_ARRAY poly_eos_K = ConstSIMD(NOSIMDpoly_eos_K);           // TOVola::poly_eos_K
