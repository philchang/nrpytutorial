...
#include "../set_CodeParameters.h"
  ...
  char filename[256];
  sprintf(filename, "out2d-xy-%s-conv_factor%.2f-t%08.2f.txt", CoordSystemName, convergence_factor, time);
  ...
  // Define points for output along the xy-plane in SinhCylindrical coordinates.
