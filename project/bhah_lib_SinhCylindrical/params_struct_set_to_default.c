...
void params_struct_set_to_default(commondata_struct *restrict commondata, griddata_struct *restrict griddata) {
  ...
  for (int grid = 0; grid < commondata->NUMGRIDS; grid++) {
    ...
    params->AMPLRHO = 10.0;                                   // nrpy.reference_metric_SinhCylindrical::AMPLRHO
    params->AMPLZ = 10.0;                                     // nrpy.reference_metric_SinhCylindrical::AMPLZ
    ...
    params->Nxx0 = 144;                                       // nrpy.infrastructures.BHaH.numerical_grids_and_timestep::Nxx0
    params->Nxx1 = 8;                                         // nrpy.infrastructures.BHaH.numerical_grids_and_timestep::Nxx1
    params->Nxx2 = 24;                                        // nrpy.infrastructures.BHaH.numerical_grids_and_timestep::Nxx2
    params->PI = 3.14159265358979323846264338327950288;       // nrpy.reference_metric::PI
    params->SINHWRHO = 0.2;                                   // nrpy.reference_metric_SinhCylindrical::SINHWRHO
    params->SINHWZ = 0.2;                                     // nrpy.reference_metric_SinhCylindrical::SINHWZ
    ...
    snprintf(params->CoordSystemName, 50, "SinhCylindrical"); // nrpy.reference_metric::CoordSystemName
  }
}
