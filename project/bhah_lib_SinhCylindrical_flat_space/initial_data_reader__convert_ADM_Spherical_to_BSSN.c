...
void initial_data_reader__convert_ADM_Spherical_to_BSSN(
  ...
  case SINHCYLINDRICAL:
    initial_data_reader__convert_ADM_Spherical_to_BSSN__rfm__SinhCylindrical(commondata, params, xx, bcstruct, gridfuncs, ID_persist, ID_function);
    break;
  default:
    fprintf(stderr, "ERROR in initial_data_reader__convert_ADM_Spherical_to_BSSN(): CoordSystem hash = %d not #define'd!\n",
