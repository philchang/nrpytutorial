...
#include "../set_CodeParameters.h"
  ...
  // Thiago says: setting flat-space initial data
  // Also, these values are possibly overwritten in BHaH_interface::getMetric() for debugging

  ADM_Cart_basis->BU0 = 0.0;
  ADM_Cart_basis->BU1 = 0.0;
  ADM_Cart_basis->BU2 = 0.0;

  ADM_Cart_basis->KDD00 = 0.0;
  ADM_Cart_basis->KDD01 = 0.0;
  ADM_Cart_basis->KDD02 = 0.0;
  ADM_Cart_basis->KDD11 = 0.0;
  ADM_Cart_basis->KDD12 = 0.0;
  ADM_Cart_basis->KDD22 = 0.0;

  ADM_Cart_basis->T4UU00 = 0.0;
  ADM_Cart_basis->T4UU01 = 0.0;
  ADM_Cart_basis->T4UU02 = 0.0;
  ADM_Cart_basis->T4UU03 = 0.0;
  ADM_Cart_basis->T4UU11 = 0.0;
  ADM_Cart_basis->T4UU12 = 0.0;
  ADM_Cart_basis->T4UU13 = 0.0;
  ADM_Cart_basis->T4UU22 = 0.0;
  ADM_Cart_basis->T4UU23 = 0.0;
  ADM_Cart_basis->T4UU33 = 0.0;

  ADM_Cart_basis->alpha = 1.0;
  ADM_Cart_basis->betaU0 = 0.0;
  ADM_Cart_basis->betaU1 = 0.0;
  // ADM_Cart_basis->betaU2 = 0.0;
  // Thiago says: uncomment line below to set betaCartU2 to a nonzero value
  ADM_Cart_basis->betaU2 = 0.01;

  ADM_Cart_basis->gammaDD00 = 1.0;
  ADM_Cart_basis->gammaDD01 = 0.0;
  ADM_Cart_basis->gammaDD02 = 0.0;
  ADM_Cart_basis->gammaDD11 = 1.0;
  ADM_Cart_basis->gammaDD12 = 0.0;
  ADM_Cart_basis->gammaDD22 = 1.0;

} // END FUNCTION ADM_SphorCart_to_Cart
/**
...
} // END FUNCTION ADM_Cart_to_BSSN_Cart
/**
...
} // END FUNCTION BSSN_Cart_to_rescaled_BSSN_rfm
/**
...
} // END FUNCTION initial_data_lambdaU_grid_interior
...
} // END FUNCTION initial_data_reader__convert_ADM_Spherical_to_BSSN__rfm__SinhCylindrical
