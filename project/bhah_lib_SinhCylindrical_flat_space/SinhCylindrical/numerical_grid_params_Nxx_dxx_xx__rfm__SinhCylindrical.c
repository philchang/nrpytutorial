...
/**
 * Initializes a cell-centered grid in SinhCylindrical coordinates based on physical dimensions (grid_physical_size).
 *
 * Inputs:
...
void numerical_grid_params_Nxx_dxx_xx__rfm__SinhCylindrical(const commondata_struct *restrict commondata, params_struct *restrict params,
  ...
  snprintf(params->CoordSystemName, 50, "SinhCylindrical");
...
#include "../set_CodeParameters.h"
    ...
    params->AMPLRHO = grid_physical_size;
    params->AMPLZ = grid_physical_size;
  }
