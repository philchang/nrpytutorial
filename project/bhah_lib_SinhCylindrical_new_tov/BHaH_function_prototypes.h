...
void Cart_to_xx_and_nearest_i0i1i2__rfm__SinhCylindrical(const commondata_struct *restrict commondata, const params_struct *restrict params,
...
void compute_T4UU(const commondata_struct *restrict commondata, const params_struct *restrict params, const int i0, const int i1, const int i2,
                  REAL *restrict xx[3], const REAL rhob, const REAL P, const REAL h, const REAL u4Ut, const REAL rescaledvU0, const REAL rescaledvU1,
...
void diagnostics_nearest_1d_z_axis(commondata_struct *restrict commondata, const params_struct *restrict params, REAL *restrict xx[3],
                                   MoL_gridfunctions_struct *restrict gridfuncs);
void diagnostics_nearest_1d_z_axis__rfm__SinhCylindrical(commondata_struct *restrict commondata, const params_struct *restrict params,
                                                         REAL *restrict xx[3], MoL_gridfunctions_struct *restrict gridfuncs);
void diagnostics_nearest_2d_xy_plane(commondata_struct *restrict commondata, const params_struct *restrict params, REAL *restrict xx[3],
                                     MoL_gridfunctions_struct *restrict gridfuncs);
void diagnostics_nearest_2d_xy_plane__rfm__SinhCylindrical(commondata_struct *restrict commondata, const params_struct *restrict params,
                                                           REAL *restrict xx[3], MoL_gridfunctions_struct *restrict gridfuncs);
...
void numerical_grid_params_Nxx_dxx_xx__rfm__SinhCylindrical(const commondata_struct *restrict commondata, params_struct *restrict params,
...
int interpolation_3d_general__uniform_src_grid(const int N_interp_GHOSTS, const REAL src_dxx0, const REAL src_dxx1, const REAL src_dxx2,
                                               ...
                                               const REAL *restrict src_gf_ptrs[], const int num_dst_pts, const REAL dst_x0x1x2[][3],
