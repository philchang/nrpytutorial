...
#include "../set_CodeParameters.h"
  ...
  char filename[256];
  sprintf(filename, "out1d-z-%s-conv_factor%.2f-t%08.2f.txt", CoordSystemName, convergence_factor, time);
  ...
  // Define points for output along the z-axis in SinhCylindrical coordinates.
  const int numpts_i0 = 1, numpts_i1 = 1, numpts_i2 = Nxx2;
  int i0_pts[numpts_i0], i1_pts[numpts_i1], i2_pts[numpts_i2];

  data_point_1d_struct data_points[numpts_i0 * numpts_i1 * numpts_i2];
  int data_index = 0;
  i0_pts[0] = (int)(NGHOSTS);
